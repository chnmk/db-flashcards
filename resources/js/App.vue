<template>
    <div>
        <div class="fixed inset-x-0 top-0 h-16 bg-indigo-500">
            <svg class="mx-6 h-16 w-6 align-bottom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
            ...
            <span class="absolute inset-x-0 top-4">
